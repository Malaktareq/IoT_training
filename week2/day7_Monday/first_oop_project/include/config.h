...
constexpr float CURRENT_THRESHOLD = 0.7; // Current threshold in Amperes
constexpr float CURRENT_SENSOR_OFFSET = 1.5585;
constexpr float CURRENT_SENSOR_SCALE = 0.122;
